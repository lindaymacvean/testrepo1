...
/**
 * The Object for displaying the screen. 
 * @class collie.DisplayObject
 * @extends collie.Component
 * @param {Object} [htOption] Options
 * @param {String} [htOption.name] Object Name. It's not unique value. You can get an instance of the DisplayObject by using collie.util.getDisplayObjectByName
 * @param {Number|String} [htOption.width="auto"] Object's width. When you set this option as "auto", The Width of the DisplayObject will be changed to the same as width of backgroundImage after having loaded the backgroundImage.
 * @param {Number|String} [htOption.height="auto"] Object's heigth, When you set this option as "auto", The Height of the DisplayObject will be changed to the same as height of backgroundImage after having loaded the backgroundImage.
